...
<br>
 <li> <b> Objetivo: </b> Crear un programa en C que mediante el arreglo de una estructura, libreria personalizada,  almacene 10 datos, que emplear funciones para realizar diversos calculos y los guarde en archivo de texto. </li>
 <br>
